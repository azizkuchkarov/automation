...
public interface IProcurementRequestService
{
    ...
    Task<Result<ProcurementRequestDto>> CompleteStepAsync(Guid id, int step, Guid actorId, string? ip, CancellationToken ct = default);
    ...
    Task<Result<ProcurementRequestDto>> AcceptMarketingAsync(Guid id, Guid actorId, string? ip, CancellationToken ct = default);
