...
{
    /// <inheritdoc />
    public partial class AddProcurementStepComments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "procurement_step_comments",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_procurement_step_comments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_procurement_step_comments_procurement_request_details_Docum~",
                        column: x => x.DocumentId,
                        principalTable: "procurement_request_details",
                        principalColumn: "DocumentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_procurement_step_comments_users_AuthorId",
                        column: x => x.AuthorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_procurement_step_comments_AuthorId",
                table: "procurement_step_comments",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_procurement_step_comments_DocumentId_Phase_StepNumber",
                table: "procurement_step_comments",
                columns: new[] { "DocumentId", "Phase", "StepNumber" });
        }
